...
models  = {'std training' :  m('z87envpm/epoch_4950.npy', 'std'),
           ...
           'summer' :  m('2k35mm2e/epoch_4950.npy', '7-std')}
model = models['summer']
...
model_path = model.path.split('/')[0] + '/inference/infesteps_1000/constraints_no_constraints/beta_0.003_20251016-121954.npy'
