#!/bin/bash
#SBATCH --job-name=dino_diffusion_VAE
#SBATCH --output=dino_diffusion_VAE.out
#SBATCH --error=dino_diffusion_VAE.out
#SBATCH --gres=gpu:1  ######4
#SBATCH --ntasks-per-node=1
#SBATCH --nodes=1
#SBATCH --hint=nomultithread
#SBATCH --time=49:30:00              # max20h on qos_gpu_t3, max 100h on qos_gpu-t4
...
# code execution
srun python train_VAE.py #--num_processes 4