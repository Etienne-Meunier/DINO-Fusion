...
class BaseConfig:
    ...
    data_file : str = os.environ['OCEANDATA']+'/Dino-Fusion/dino_1_4_degree_coarse_240125_summer.tar' #'/home/meunier/Data/Dino-Fusion/dino_1_4_degree.tar',
