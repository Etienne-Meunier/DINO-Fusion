...
class BaseConfig:
    ...
    #data_file : str = os.environ['OCEANDATA']+'Dino-Fusion/dino_1_4_degree_040924_v2.tar' #this one for the latent 1/4 work
    data_file : str = os.environ['OCEANDATA']+'Dino-Fusion/dino_1_4_degree_coarse_130924.tar' #this one for the latent 1/4 work
